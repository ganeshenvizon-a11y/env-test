/**
 * Envizon Studio - About Page GSAP Animations Controller
...
export function initAboutAnimations() {
    ...
    if (prefersReducedMotion) {
        ...
        gsap.set('.about-hero__title, .about-hero__text, .about-hero__gallery-item, .about-communication__heading, .about-communication__pills, .about-communication__panels, .about-values__header, .about-partnerships__header, .partnership-card, .about-process__heading, .process-card, .insights__container', { opacity: 1 });
        return;
    }
    ...
    // Make title visible
    gsap.set('.about-hero__title', { opacity: 1 });
    ...
    // ----------------------------------------------------
    // 3. Communication Section Animations
    // ----------------------------------------------------
    const commTl = gsap.timeline({
        scrollTrigger: {
            trigger: '.about-communication',
            start: 'top 80%'
        }
    });
    ...
    // ----------------------------------------------------
    // 5. Partnerships Section Reveal
    // ----------------------------------------------------
    gsap.fromTo('.about-partnerships__header',
        { y: 40, opacity: 0 },
        {
            y: 0,
            opacity: 1,
    ...
    gsap.fromTo('.partnership-card',
        { y: 40, opacity: 0 },
        {
            ...
            ease: 'power2.out',
            scrollTrigger: {
                trigger: '.about-partnerships__cards',
                start: 'top 85%'
            }
        }
    );
    ...
    partnerCards.forEach(card => {
        const media = card.querySelector('.partnership-card__media');
        card.addEventListener('mouseenter', () => {
            gsap.to(media, { y: -8, scale: 1.01, duration: 0.35, ease: 'power2.out' });
        });
        card.addEventListener('mouseleave', () => {
            gsap.to(media, { y: 0, scale: 1, duration: 0.35, ease: 'power2.out' });
        });
    });
    ...
    // ----------------------------------------------------
    gsap.fromTo('.about-process__heading',
        { y: 40, opacity: 0 },
        {
            y: 0,
            opacity: 1,
    ...
    // ----------------------------------------------------
    // 7. Insights Section ScrollTrigger
    // ----------------------------------------------------
    ...
    // ----------------------------------------------------
    // 8. Global Call-to-Action Section
    // ----------------------------------------------------
    ...
    // ----------------------------------------------------
    // 9. Footer soft stagger-in ScrollTrigger
    // ----------------------------------------------------
